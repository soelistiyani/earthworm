# Create an Earthworm environment on SPARC Solaris
# This file should be sourced by a Bourne shell wanting
# to run or build an EARTHWORM system under SPARC Solaris.
...
export CPPFLAGS="-D_SOLARIS -D_SPARC -D_FILE_OFFSET_BITS=64 -I${EW_HOME}/${EW_VERSION}/include"
