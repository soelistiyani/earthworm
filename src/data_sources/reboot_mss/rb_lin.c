 ...
 *    Revision history:
 *     $Log$
 *     Revision 1.1  2010/01/02 00:39:51  kress
...
/* Error detected by recv()
   ************************/
   ...
   {
      if ( !Quiet ) printf( "An unexpected nonreadable event occurred.\n" );
      return -1;
   }
}
